...
Original file is located at
    https://colab.research.google.com/drive/1MJTMOUhZCa8dhPeLwl3E1KJr0jvosfTt
...
predictions_df.to_csv('predicted_values_xg.csv', index=False)
...
# # save the dataframe to a csv file
# feat_imp_df.to_csv('feature_importance_xg.csv', index=False)
...
# r = permutation_importance(estimator=xgb, X=X_train, y=y_train, n_repeats=3, random_state=7)
...
# # save the dataframe to a csv file
# feat_imp_df.to_csv('mean_importances_xg.csv', index=False)
...
# with open('sequence_xg.txt', 'w') as f:
#     f.write(sequence)